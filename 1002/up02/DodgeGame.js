...
function drawScreen() {
    ...
    if(GameState == GAME_STATE_READY) {
        ctx.fillText("준비", 330, 180);
    // 게임 중
    } else if(GameState == GAME_STATE_GAME) {
        ctx.drawImage(imgMissile, tempMissile1.x, tempMissile1.y);
        ctx.drawImage(imgMissile, tempMissile2.x, tempMissile2.y);
        ctx.drawImage(imgMissile, tempMissile3.x, tempMissile3.y);
        ctx.drawImage(imgMissile, tempMissile4.x, tempMissile4.y);
    // 게임 오버
    } else if(GameState == GAME_STATE_OVER) {
        ctx.fillText("게임 오버", 330, 180);
    }
}
